...
if(localStorage.getItem('docs') != null){
    orcamentoJSON = JSON.parse(localStorage.getItem('docs'))
}
...
function calcularTotal(){
    ...
    localStorage.setItem('docs',JSON.stringify(orcamentoJSON))
}
...
function removeSessao(){
    ...
    localStorage.setItem('docs',JSON.stringify(orcamentoJSON))
    orcamento.innerHTML = JSON.stringify(orcamentoJSON)
    parent.remove()
    location.reload()
}